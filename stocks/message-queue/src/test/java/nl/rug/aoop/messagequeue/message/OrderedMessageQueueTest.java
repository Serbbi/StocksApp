...
/**
 * Tests the {@link OrderedMessageQueueTest} Class implementation.
 */
class OrderedMessageQueueTest {

    private OrderedMessageQueue omq;
    ...
    void testDequeueEmpty() {
        assertThrows(NoSuchElementException.class, () -> omq.dequeue());
    }
