...
public class SellOrderQueueTest {
    ...
    private Order getTestStock(String stockSymbol, double price) {
        Order o = new Order(OrderType.SELL, "id", stockSymbol, price, 10);
        return o;
    }

    @BeforeEach
    void beforeEach() {
        boq = new SellOrderQueue();
    ...
    @Test
    void testEnqueueBuyOrder() {
        Order o = new Order(OrderType.BUY, "IDIDID", "A", 10.0, 10);
